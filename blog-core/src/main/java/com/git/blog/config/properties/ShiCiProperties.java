...
@Data
@Configuration
@ConfigurationProperties(prefix = "open.blog.shi.ci")
public class ShiCiProperties implements Cloneable{
    /**标题*/
    private String title = "平原人的博客";
    /**作者*/
    private String author = "平原人";
    /**作者*/
    private String description = "诗词歌赋";

    /**关键字*/
    private String keyword = "诗词歌赋";
    ...
    @Override
    public ShiCiProperties clone(){
        try {
            ShiCiProperties clone = (ShiCiProperties)super.clone();
