...
public class PageController {
    ...
    private Pattern pattern = Pattern.compile("(!\\[[^\\]]*\\]\\()(http?:\\/\\/)opadmin\\.pingyuanren\\.top(\\/[^)]*\\))");
    private Pattern pattern2 = Pattern.compile("(!\\[[^\\]]*\\]\\()(https?:\\/\\/)opadmin\\.pingyuanren\\.top(\\/[^)]*\\))");
    ...
    public ModelAndView articleId(@PathVariable("id") Long id) {
        ...
        try {
            ...
            if (parse != null && StringUtils.isNotEmpty(parse.getTocHtml())) {
                ...
                String articleHtml = parse.getArticleHtml();
                String s = PageUtil.replaceImg(sysProperties.getImgHost(), articleHtml);
